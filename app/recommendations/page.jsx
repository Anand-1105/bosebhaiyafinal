...
import { Star, Quote, MessageSquare, Linkedin, ChevronDown, User, Award } from 'lucide-react';
import { PROFESSIONAL_COMMENTS, TESTIMONIALS } from '../lib/data';
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 md:px-10 overflow-hidden text-center">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8">
            <Award size={16} className="text-[#84ADFF]" />
            <span className="text-[11px] font-black uppercase tracking-[0.2em] text-white/60">Industry Recognition</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tight mb-6">
            Professional <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#84ADFF] to-[#3D5BF1]">Praise.</span>
          </h1>
          <p className="text-white/40 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
            Endorsements and testimonials from industry leaders, startup founders, and technical experts about my contribution to the tech ecosystem.
          </p>
        </div>
      </section>
      ...
      <section className="pb-24 px-4 sm:px-6 md:px-10 relative">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex items-center gap-4 mb-16">
            ...
            <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-[#84ADFF]">Linkedln Professional Feed</h3>
            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-white/10 to-transparent" />
          </div>
          ...
          <div className="flex justify-center mt-12">
            ...
            >
              {showAll ? 'Show Less' : `See All ${PROFESSIONAL_COMMENTS.length} Recommendations`}
