...
export function ScheduleModal({ onClose }) {
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-md animate-fadeIn">
      <div className="relative bg-[#0A1228] border border-[#5363B1]/30 rounded-[1.5rem] sm:rounded-[2rem] w-full max-w-lg shadow-[0_40px_100px_rgba(0,0,0,0.7)] animate-modalIn flex flex-col">
