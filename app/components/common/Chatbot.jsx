...
export default function Chatbot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
      {/* Chat Window */}
      {isOpen && (
        <div className="mb-4 w-[280px] sm:w-[320px] h-[400px] sm:h-[500px] bg-[#0D1635] border border-white/10 rounded-[24px] shadow-2xl overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300">
          {/* Header */}
